...
const navigateBasedOnRole = (role) => {
    switch (role) {
        ...
        case 'clubOwner':
            return '/owner/';
        case 'coach': // Assuming coaches have a separate flow, otherwise they could be treated as club owners
            return '/coach/';
        default:
            return '/login'; // Default redirect if the role is not recognized
    }
};
export {
    getCurrentUser,
