...
export const CREATE_SEVEN_DAY_SESSIONS_TEMPLATE_FROM_CLUB_ID = gql`
  mutation CreateSevenDaySessionsTemplateFromClubId($sevenDaySessionTemplateInput: SevenDaySessionTemplateInput!, $clubId: ID!){
...
mutation CreateSevenDaySessionTemplateWithoutSessions($input: SevenDaySessionTemplateInput!, $clubId: ID!, $coachId: ID!) {
  createSevenDaySessionTemplateWithoutSessions(input: $input, clubId: $clubId, coachId: $coachId) {
    id
    templateName
    coach
    sessionTemplates {
